...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 955,             /* -m128bit-long-double */
  OPT_m32 = 956,                             /* -m32 */
  OPT_m3dnow = 957,                          /* -m3dnow */
  OPT_m3dnowa = 958,                         /* -m3dnowa */
  OPT_m64 = 959,                             /* -m64 */
  OPT_m80387 = 960,                          /* -m80387 */
  OPT_m8bit_idiv = 961,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 962,              /* -m96bit-long-double */
  OPT_mabi_ = 963,                           /* -mabi= */
  OPT_mabm = 964,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 965,       /* -maccumulate-outgoing-args */
  OPT_maes = 966,                            /* -maes */
  OPT_malign_double = 967,                   /* -malign-double */
  OPT_malign_functions_ = 968,               /* -malign-functions= */
  OPT_malign_jumps_ = 969,                   /* -malign-jumps= */
  OPT_malign_loops_ = 970,                   /* -malign-loops= */
  OPT_malign_stringops = 971,                /* -malign-stringops */
  OPT_march_ = 972,                          /* -march= */
  OPT_masm_ = 973,                           /* -masm= */
  OPT_mavx = 974,                            /* -mavx */
  OPT_mbmi = 975,                            /* -mbmi */
  OPT_mbranch_cost_ = 976,                   /* -mbranch-cost= */
  OPT_mcld = 977,                            /* -mcld */
  OPT_mcmodel_ = 978,                        /* -mcmodel= */
  /* OPT_mcpu_ = 979, */                     /* -mcpu= */
  OPT_mcrc32 = 980,                          /* -mcrc32 */
  OPT_mcx16 = 981,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 982,             /* -mdispatch-scheduler */
  OPT_mf16c = 983,                           /* -mf16c */
  OPT_mfancy_math_387 = 984,                 /* -mfancy-math-387 */
  OPT_mfentry = 985,                         /* -mfentry */
  OPT_mfma = 986,                            /* -mfma */
  OPT_mfma4 = 987,                           /* -mfma4 */
  OPT_mforce_drap = 988,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 989,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 990,                        /* -mfpmath= */
  OPT_mfsgsbase = 991,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 992, */               /* -mfused-madd */
  OPT_mhard_float = 993,                     /* -mhard-float */
  OPT_mieee_fp = 994,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 995,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 996,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 997,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 998, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 999,          /* -mlarge-data-threshold= */
  OPT_mlwp = 1000,                           /* -mlwp */
  OPT_mmmx = 1001,                           /* -mmmx */
  OPT_mmovbe = 1002,                         /* -mmovbe */
  OPT_mms_bitfields = 1003,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1004,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1005,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1006,                  /* -mno-push-args */
  OPT_mno_red_zone = 1007,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1008,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1009,       /* -momit-leaf-frame-pointer */
  OPT_mpc = 1010,                            /* -mpc */
  OPT_mpclmul = 1011,                        /* -mpclmul */
  OPT_mpopcnt = 1012,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1013,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1014,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1015,                     /* -mpush-args */
  OPT_mrdrnd = 1016,                         /* -mrdrnd */
  OPT_mrecip = 1017,                         /* -mrecip */
  OPT_mred_zone = 1018,                      /* -mred-zone */
  OPT_mregparm_ = 1019,                      /* -mregparm= */
  OPT_mrtd = 1020,                           /* -mrtd */
  OPT_msahf = 1021,                          /* -msahf */
  OPT_msoft_float = 1022,                    /* -msoft-float */
  OPT_msse = 1023,                           /* -msse */
  OPT_msse2 = 1024,                          /* -msse2 */
  OPT_msse2avx = 1025,                       /* -msse2avx */
  OPT_msse3 = 1026,                          /* -msse3 */
  OPT_msse4 = 1027,                          /* -msse4 */
  OPT_msse4_1 = 1028,                        /* -msse4.1 */
  OPT_msse4_2 = 1029,                        /* -msse4.2 */
  OPT_msse4a = 1030,                         /* -msse4a */
  /* OPT_msse5 = 1031, */                    /* -msse5 */
  OPT_msseregparm = 1032,                    /* -msseregparm */
  OPT_mssse3 = 1033,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1034,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1035,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1036,            /* -mstringop-strategy= */
  OPT_mtbm = 1037,                           /* -mtbm */
  OPT_mtls_dialect_ = 1038,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1039,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1040,                         /* -mtune= */
  OPT_mveclibabi_ = 1041,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1042,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1043,                    /* -mvzeroupper */
  OPT_mxop = 1044,                           /* -mxop */
  OPT_n = 1045,                              /* -n */
